...
class DocumentAuditor:
    ...
    def __init__(self, poppler_path, tesseract_path):
        ...
        # If running on Linux (Cloud), Tesseract is registered globally in the system PATH
        if os.name == 'posix':
    ...
    def read_pdf(self, pdf_path):
        ...
        try:
            # On Linux cloud, poppler_path can be None if installed globally
    ...
    def _export_to_csv(self, output_path, data):
        """Writes the structured data matrix into a clean CSV file."""
